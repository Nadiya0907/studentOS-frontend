...
const mockPosts = [
  ...
  },
  {
    ...
    author: "Sneha",
    content:
      "Looking for two teammates for a college project. We are planning to build an AI-powered student productivity platform.",
    category: "projects",
    likes: 32,
    comments: 15,
    time: "Yesterday",
...
export default function Community() {
  ...
  const createPost = async () => {
    ...
    try {
      ...
      toast.error(
        "Could not publish post. Backend may not be connected yet."
      );

      // Keep the UI useful while backend is unavailable.
      const newPost = {
        id: Date.now(),
        author: "You",
        content: text.trim(),
  ...
  const toggleLike = async (post) => {
    ...
    try {
      if (communityService.likePost && id) {
        await communityService.likePost(id);
      }
    } catch (error) {
      // Keep UI responsive while backend is unavailable.
    }
  };
                  ...
                  >
                    ...
                    <div className="mt-5 flex items-center justify-between border-t border-bg-border pt-4">
                      <div className="flex items-center gap-5">
                        ...
                        <button
                          type="button"
                          className="flex items-center gap-1.5 text-xs text-gray-600 transition hover:text-violet-400"
                        >
        ...
        <div className="space-y-5">
          ...
          <Card>
            ...
            <p className="mt-4 text-sm leading-6 text-gray-500">
              Looking for teammates? Share your skills, project
              interests and what kind of collaborator you need.
            </p>
          ...
          <Card>
            ...
            <ul className="mt-4 space-y-3 text-xs leading-5 text-gray-500">
              ...
              <li>• Help fellow students learn and grow.</li>
            </ul>
          </Card>
        </div>
      </div>
